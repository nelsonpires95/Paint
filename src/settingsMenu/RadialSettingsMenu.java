...
import core.RadialMenuItem;
import core.RadialMenuItemBuilder;
...
public class RadialSettingsMenu extends Group {
	...
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/colors.png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/effects.png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/shapes.png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/scissors.png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/select.png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/text (1).png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/text (2).png");
	addMenuItem("resources/icons/gemicon/PNG/32x32/row 1/tools.png");
	...
	final ImageView centerView = getImageView(iconPath.replace("32x32","32x32"));
	final ImageView value1View = getImageView(iconPath.replace("row 1","row 2"));
	final ImageView value2View = getImageView(iconPath.replace("row 1","row 3"));
	final ImageView imageViewWhite = getImageView(iconPath.replace(".png","W.png"));
	...
	Group valueGroup;
	if (Math.random() < 0.5) {
	    final ImageView value3View = getImageView(iconPath.replace("row 1","row 4"));
